   ...
   <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <!--   <li><a href="wilayah.php">Wilayah</a></li> -->
        ...
        <li><a class="btn btn-warning"><?php echo "Welcome ".$_SESSION['userid']."";?></a></li></ul>
          
    <ul class="nav navbar-nav navbar-right">
        <li><a href="../login/index.php"><span class="glyphicon glyphicon-log-in"></span> LogOut</a></li></ul>
     </div>
  </div>
</nav>
 ...
 <div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <table class="table table-striped">
                ...
                <th>LATITUDE</th>
                <th>LONGITUDE</th>
                <td class='text-center'><a data-target='#modal-add' data-toggle='modal'><i class="btn btn-success">Tambah</a></td>
                </tr>
                </thead>
        <tbody>
        <?php
