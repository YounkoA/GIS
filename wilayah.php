...
//     {
//     var uluru ={lat: 5.323831, lng: 95.983532};
//   var marker = new google.maps.Marker({position: uluru, map: map});

// }
            var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(5.323831, 95.983532),
                    map: map,
                    icon:'img/4.png',
                    // title: 'Klik Saya'
               });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.336906, 95.926151),
                map: map,
                icon:'img/4.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.1996207, 96.3217061),
                map: map,
                icon:'img/4.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.384432, 95.957527),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.333038, 96.005341),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.360859, 95.984626),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.346218, 95.991918),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.3765771, 95.9702181),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.325913, 96.000970),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.3246708, 95.9836693),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.3251566, 95.9837046),
                map: map,
                icon:'img/3.png',
                });

            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.343748, 95.994204),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.369987, 95.958501),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.344613, 95.993571),
                map: map,
                icon:'img/3.png',
                });
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(5.269199, 96.130387),
                map: map,
                icon:'img/4.png',
                });

            // var infowindow = new google.maps.InfoWindow({
            //         content: 'CV.Muhammad Noernikkmat'
            //         content: 'PT.Indung Tulot Energy'
            //         content: 'PT.Maar Perkasa Jaya Gas'
            //         content: 'UD. Jasa Keluarga'
            //         content: 'Maimun'
            //         content: 'M Ali'
            //         content: 'Rahma Yanti'
            //         content: 'BKPS'
            ...
            //         content: 'Jufri'
            //         content: 'Efendi'
            //         content: 'SPPBE Rahmat Seulawah Jantan'
            //    });
