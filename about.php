...
</head><body class="w3-black" style="">
...
<!-- <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="wilayah.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-eye w3-xxlarge"></i>
    <p>Ant Colony</p>
  </a>
  <a href="hitungjarak.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
...
<!-- <div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-theme-l1 w3-opacity w3-hover-opacity-off w3-center w3-small">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="7.jpg" alt="boy" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-collapse" id="about">
    ...
    <img src="7.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
